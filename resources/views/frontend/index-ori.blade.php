            ...
            <div class="lg:w-1/2 mb-10 lg:mb-0">
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <button onclick="window.location.href='product.html';"
                        class="border border-primary-orange bg-primary-orange text-white px-6 py-3 rounded-br-[16px] rounded-tl-[16px] font-medium hover:bg-transparent hover:text-primary-orange transition duration-300">
                        Belanja Sekarang
                    </button>
                    <button onclick="window.location.href='order-tracking.html';"
                        class="border border-primary-orange text-primary-orange px-6 py-3 rounded-bl-[16px] rounded-tr-[16px] font-medium hover:bg-primary-orange hover:text-white transition duration-300">
                        Lacak Pesanan
                    </button>
                </div>
            </div>
        ...
        <div class="w-full lg:max-w-7xl mx-auto px-4">
            ...
            <div id="skin-dry" class="skin-content hidden grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="bg-primary-light p-6 rounded-tl-[32px] rounded-br-[32px] product-card">
                    ...
                    <p class="text-gray-600 mb-4">Pembersih krim dengan hyaluronic acid yang tidak membuat kulit kering.
                    </p>
                </div>
            ...
            <div id="skin-combination" class="skin-content hidden grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="bg-primary-light p-6 rounded-tl-[32px] rounded-br-[32px] product-card">
                    ...
                    <p class="text-gray-600 mb-4">Pembersih yang membersihkan area berminyak tanpa mengeringkan area kering.</p>
                </div>
                ...
                <div class="bg-primary-light p-6 rounded-tl-[32px] rounded-br-[32px] product-card">
                    ...
                    <p class="text-gray-600 mb-4">Serum yang mengontrol minyak di T-zone sambil melembapkan area kering.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="w-full lg:max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @foreach ($products as $product)
                    <div class="bg-white rounded-br-[16px] rounded-tl-[16px] overflow-hidden product-card">
                        <div class="relative">
                            <img
                            ...
                            @if ($product?->is_featured)
                                <span class="absolute top-0 right-0 bg-primary-orange text-white text-sm font-semibold px-2 py-1 rounded">
                                    BESTSELLER
                                </span>
                            @endif

                            <span class="absolute bottom-0 left-0 bg-primary-red text-white text-sm font-semibold px-2 py-1 rounded">
            ...
            <div class="mt-8 text-center">
                <a href="#" class="inline-block bg-primary-orange text-white px-6 py-3 rounded-br-[16px] rounded-tl-[16px] font-medium hover:shadow-lg hover:shadow-orange-500/50 transition duration-300">
                    Lihat Semua Produk
                </a>
            </div>
        </div>
