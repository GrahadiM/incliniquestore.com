...
<!-- Footer -->
<footer class="bg-gray-800 text-white py-12 lg:pb-12 pb-24">
    <div class="w-full lg:max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 text-md gap-8">
            <div class="col-span-1 md:col-span-3 lg:col-span-1">
                <h3 class="text-xl font-bold mb-4">Inclinique<span class="text-primary-orange"> Store</span></h3>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white">Shop All</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Blog</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Offline Store</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white">Membership Terms & Conditions</a></li>
